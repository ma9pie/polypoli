...
function StandingCommitteeAttendance() {
  const displayNum = 7;
  ...
  useEffect(() => {
    ...
    setTotalPageNum(Math.ceil(tmnp2.length / displayNum));
  }, []);
...
export default StandingCommitteeAttendance;

StandingCommitteeAttendance.getLayout = function getLayout(page) {
